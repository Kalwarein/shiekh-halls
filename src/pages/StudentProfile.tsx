      ...
      >
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            {student.admission_number} • {(student.classes as any)?.name}
          </p>
        </div>
      </motion.div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm">{(student.classes as any)?.name}</span>
                </div>
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-xl font-bold">{grades?.length || 0}</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                    ...
                    <div className="space-y-3">
                      {payments?.map((payment) => (
                        <div key={payment.id} className="flex justify-between items-center p-3 border rounded-lg">
                          <div>
                            <p className="font-medium">${Number(payment.amount_paid).toFixed(2)}</p>
            ...
            <TabsContent value="attendance" className="space-y-4">
              <Card className="card-premium">
                <CardHeader>
                  ...
                  <CardDescription>Attendance record overview</CardDescription>
                </CardHeader>
                <CardContent>
                  {attendanceLoading ? (
                      ...
                      {grades?.map((grade) => (
                        <div key={grade.id} className="flex justify-between items-center p-3 border rounded-lg">
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                              {grade.term} Term, {grade.academic_year}
                            </p>
                          </div>
